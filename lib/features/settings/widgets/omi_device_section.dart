...
import 'package:parachute_daily/features/recorder/providers/omi_providers.dart';
import 'package:parachute_daily/features/recorder/screens/device_pairing_screen.dart';
...
class OmiDeviceSection extends ConsumerWidget {
    ...
    return Column(
      ...
      children: [
        const SettingsSubsectionHeader(
          title: 'Omi Device',
          subtitle: 'Connect your Omi wearable for hands-free recording',
        ),
  ...
  Future<void> _forceReflashFirmware(
      BuildContext context, WidgetRef ref) async {
    final connectedDeviceAsync = ref.read(connectedOmiDeviceProvider);
    final connectedDevice = connectedDeviceAsync.value;
