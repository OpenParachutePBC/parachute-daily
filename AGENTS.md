...
This is a standalone repository: [parachute-daily](https://github.com/OpenParachutePBC/parachute-daily)

**Related repos:**
- [parachute-chat](https://github.com/OpenParachutePBC/parachute-chat) - AI chat assistant (requires base)
